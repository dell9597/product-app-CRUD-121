...
class _ShowProductPageState extends State<ShowProductPage> {
  ...
  Future<String?> getList() async {
    ...
    var url = Uri.parse("https://laravel-dell.herokuapp.com/api/product");
                    ...
                    trailing: IconButton(
                      onPressed: () {
                        ...
                        var alertDialog = AlertDialog(
                          ...
                          content: Text(
                              'คุณต้องการลบสินค้า ${item.name} ใช่หรือไม่'),
                          actions: [
                            TextButton(
  ...
  Future<void> deleteProduct(int? id) async {
    ...
    var url = Uri.parse('https://laravel-dell.herokuapp.com/api/product/$id');
  ...
  Future<void> logout() async {
    ...
    var url = Uri.parse('https://laravel-dell.herokuapp.com/api/logout');
